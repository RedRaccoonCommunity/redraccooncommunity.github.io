...
OSCP 시험은 오지선답중에 모르면 무조건 3번을 찍는 객관식 시험이나 이해하지 못해도 무작정 외워 통과할수 있는 주입식 교육에 익숙한 한국인에겐 너무나도 당황스러운 시험이다. 일단, 악명 높은 OSCP 시험 난이도는 둘째치고, 아래와 같이 시험  구성이 굉장히 특이하다.

![공식 OSCP Exam Guide 중](../assets/images/OSCP-2024/1.png)
...
![OSCP를 공부했던 과거 나의 모습...](../assets/images/OSCP-2024/2.jpg)
...
[OSCP 구매 링크](https://www.offsec.com/registration/)
...
![이 노래는 OSCP 공부에 전혀 도움되지 않는다.](https://github.com/user-attachments/assets/ea90e53f-3738-40f0-be15-78ce0ce3f2d5)
...
![OSCP 통과하는 ,  Try Harder](https://github.com/user-attachments/assets/83c0c72e-7eb7-4744-8eef-86f642403ccb)
...
![말이나 못하면...](../assets/images/OSCP-2024/8.png)
...
따라서 통과하는 법(How to pass)이 아닌 준비하는 법 (How to prepare)에 대하 알아보도록 하자.

**OSCP Like machines 풀기**
[NetSecFocus Trophy Room- HackTheBox's OSCP 링크](https://docs.google.com/spreadsheets/u/1/d/1dwSMIAPIam0PuRBkCiDI88pU3yzrqqHkDtBngUHNCw8/htmlview)
...
마지막으로 한국 사이버 보안 유투브 채널 레드라쿤(구 Groot Security)와 Choi Security에서도 HackTheBox 한국어 문제 풀이를 제공하고 제공할 예정이니 한국어로 된 문제 풀이를 보고 싶다면 구독과 좋아요, 알림 설정까지 부탁한다.
...
![9.png](../assets/images/OSCP-2024/9.png)
...
![100점 만점에 70점 이상 받아야 통과](../assets/images/OSCP-2024/10.png)
...
![OSCP 시험 당일의 모습..](https://github.com/user-attachments/assets/788de351-c936-4e2e-852c-af2f657ad038)
